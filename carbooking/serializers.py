...
class BookedDateSerializer(serializers.HyperlinkedModelSerializer):
    ...
    This serializer manages the conversion of BookedDate instances to and from JSON,
    linking the booking to the respective car and user.
    """
...
class UserSerializer(serializers.HyperlinkedModelSerializer):
    ...
    This serializer is used to manage the conversion of User instances to and from JSON,
    including password hashing before saving.
    """
